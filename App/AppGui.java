...
class App {
    ...
    static boolean menuIsExist(String jenis,String nama){
        ...
        while (i.hasNextLine()){
            ...
            if(nama.toLowerCase().equals(splitted[0].toLowerCase())){
                return true;
            }
        }
        return false;
   ...
   static boolean deleteMenu(String jenis, String nama){
       if(!menuIsExist(jenis,nama)){
           return false;
       }
       String tmp= "";
       jenis=jenis.toLowerCase();
