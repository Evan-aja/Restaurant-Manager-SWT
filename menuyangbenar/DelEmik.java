 ...
 * @author evan
 */
public class DelEmik extends javax.swing.JFrame {

    /**
     * Creates new form DelEmik
     */
    public DelEmik() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (JOptionPane.showConfirmDialog( delete,"Apakah Anda Yakin?","Hapus Menu Minuman",
            JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION){
            try {
                DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
                data.hapusEmik((String) model.getValueAt(jTable1.getSelectedRow(),0), (String) model.getValueAt(jTable1.getSelectedRow(),1));
            } catch (Exception ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DelEmik.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
